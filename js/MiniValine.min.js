!
    function(e, t) {
        ...
        return function(e) {
            function t(t) {
                for (var n, a, r = t[0], o = t[1], s = 0, l = []; s < r.length; s++) a = r[s],
            ...
            a.e = function(e) {
                ...
                return 0 !== l && (l ? c.push(l[2]) : (s = new Promise((function(t, n) {
                    ...
                    }), 12e4), t.onerror = t.onload = r, document.head.appendChild(t))),
                    Promise.all(c)
            },
                a.m = e,
                a.c = n,
                ...
                a.t = function(e, t) {
                    ...
                    if (a.r(n), Object.defineProperty(n, "default", {
                        enumerable: !0,
                        value: e
                    }), 2 & t && "string" != typeof e) for (var i in e) a.d(n, i,
                        function(t) {
                            return e[t]
                        }.bind(null, i));
                    return n
            ...
            var i = {
                on: function(e, t, n, a) {
                    for (var r = 0,
                             o = (e = e.split(" ")).length; r < o; r++) i.off(e[r], t, n, a),
                        t.addEventListener ? t.addEventListener(e[r], n, a || !1) : t.attachEvent ? t.attachEvent("on".concat(e[r]), n) : t["on".concat(e[r])] = n
                },
                off: function(e, t, n, i) {
                    for (var a = 0,
                             r = (e = e.split(" ")).length; a < r; a++) t.removeEventListener ? t.removeEventListener(e, n, i || !1) : t.detachEvent ? t.detachEvent("on".concat(e), n) : t["on".concat(e)] = null
                }
            };
            e.exports = i
        },
            function(e, t, n) {
                ...
                Object.defineProperty(t, "__esModule", {
                    ...
                    t.VERSION = "4.2.2",
                    t.GBUrl = "https://fdn.geekzu.org/avatar/",
            ...
            function(e, t, n) {
                ...
                e.exports = function(e) { (e = e || {}).type = (e.type || "GET").toUpperCase(),
            ...
            function(e, t, n) {
                ...
                e.exports = function(e, t, n) {
                    if (n) t();
                        ...
                        i.onload = i.onreadystatechange = function(e, n) { ! n && i.readyState && !/loaded|complete/.test(i.readyState) || (i.onload = i.onreadystatechange = null, i = void 0, !n && t && setTimeout(t, 0))
                        },
                            i.src = e;
                        try {
                ...
                o.prototype.initCheck = function() {
                    ...
                    try {
                        var t = setInterval((function() {
                            void 0 !== e.i18n && (clearInterval(t), a.
                            default.setAV(e), a.
                            default.widgets(e), a.
                            default.visitor(e), document.querySelectorAll(e.config.el)[0] && (e.ele = i.
                            default.ele(e), a.
                            default.script(e, 1)))
                        }), 5)
                    } catch(e) {}
                    ...
                    o.prototype.initBody = function() {
                        ...
                        try {
                            ...
                            default.cloudFlag(e),
                                ...
                                default.initCount(e),
                                a.
                                default.insertComment(e, i.
                                    default),
                                a.
                                default.parentQuery(e),
                                a.
                                default.nestQuery(e),
                                a.
                                default.alert(e),
                                ...
                                default.resetForm(e),
                                a.
                                default.uploadImage(e),
                                a.
                                default.cancelReply(e),
                                a.
                                default.smileBtnEvt(e),
                                a.
                                default.previewBtnEvt(e),
                                a.
                                default.atEvt(e),
                                a.
                                default.submitBtnEvt(e),
                                a.
                                default.smile(e)
                        } catch(e) {}
                    },
                        ...
                        if (clearInterval(t), void 0 !== window.MV.emoticonList && 0 != window.MV.emoticonList.length) {
                            for (var n = e.el.querySelector(".smile-icons ul"), i = e.el.querySelector(".smile-bar ul"), a = window.MV.emoticonList || [], r = 0; r < a.length; r++) {
                                for (var o = document.createElement("li"), s = document.createElement("li"), c = 0; c < a[r].length; c++) {
                                    ...
                                    if (0 === c) { (l = document.createElement("img")).setAttribute("data-src", "".concat(a[r][0]));
                                        try {
                                            s.appendChild(l)
                                        } catch(e) {}
                                    }
                            ...
                            try {
                                ...
                                for (var u = document.querySelectorAll(".smile-bar > ul > li"), d = document.querySelectorAll(".smile-icons > ul > li"), f = 0; f < u.length; f++) u[f].index = f,
                                    u[f].onclick = function() {
                                        for (var e = 0; e < u.length; e++) u[e].className = "",
            ...
            function(e, t, n) {
                ...
                e.exports = function(e) {
                    ...
                    "[object HTMLDivElement]" === Object.prototype.toString.call(t) && (e.el = t, e.el.classList.add("v"), e.el.innerHTML = e.ele, e.powerMode && e.el.addEventListener("input", a.
                        default))
                }
            },
            function(e, t, n) {
                ...
                function u() {
                    ...
                    for (var e = !1,
                             t = i.getBoundingClientRect(), n = 0; n < r.length; ++n) {
                        var o = r[n];
            ...
            function(e, t, n) {
                "use strict";
                function i(e, t, n) {
                    var i = n && n.debug || !1; ! i || (c = document.querySelector("#input-textarea-caret-position-mirror-div")) && c.parentNode.removeChild(c),
            ...
            function(module, exports, __webpack_require__) {
                ...
                var i18n = function i18n(root) {
                    var s;
                    window.MV.i18n ? (root.i18n = window.MV.i18n, window.MV.getI18n = 0) : (s = localStorage && localStorage.getItem("_ValineI18n"), s ? (s = JSON.parse(s), s.lang == root.lang ? (root.i18n = s.i18n, window.MV.i18n = root.i18n, window.MV.getI18n = 0) : window.MV.getI18n = 1) : window.MV.getI18n = 1, window.MV.getI18n && (0, _ajax2.
                        default)({
                        url:
                            _Default.i18nUrl + root.lang + "/index.json",
                        type: "GET",
                ...
                var smile = function(e) {
                        if (window.MV.emoticonUrl = e.emoticonUrl, window.MV.emoticonList) e.emoticonList = window.MV.emoticonList,
                            ...
                            if (window.MV.getSmile) {
                                ...
                                window.MV.emoticonList = e.emoticonList,
                                    window.MV.emoticon = e.emoticon
                            } else e.emoticonList = window.MV.emoticonList,
                                e.emoticon = window.MV.emoticon;
                            setTimeout((function() {
                    ...
                    getSmile = function getSmile(root, Url) { (0, _ajax2.
                        default)({
                        url:
                            Url + "/index.json",
                        type: "GET",
                        success: function success(data) {
                            data = eval("(" + data + ")");
                            for (var tmp = [], i = 0; i < data[0].length; i++) tmp.push(Url + "/" + data[0][i]),
            ...
            function(e, t, n) {
                ...
                e.exports = function(e) {
                    var t;
                    1 < arguments.length && void 0 !== arguments[1] && arguments[1] ? (t = [], window.autosize || t.push("npm/autosize@4.0.2/dist/autosize.min.js"), window.filterXSS || t.push("npm/xss@1.0.8/dist/xss.min.js"), e.config.closeUA || window.UAParser || t.push("npm/ua-parser-js@0.7.22/src/ua-parser.min.js"), !e.math && void 0 !== e.config.math || "undefined" != typeof MathJax || t.push("npm/mathjax@3/es5/tex-svg.js"), !e.md && void 0 !== e.config.md || window.marked || t.push("npm/marked@1.2.0/lib/marked.min.js"), (0, i.
                        default)("https://cdn.jsdelivr.net/combine/" + t.join(","), (function() {
                        e.initBody(),
                            window.MV.scriptEle = !0
                    }), 1 == window.MV.scriptEle || 0 == t.length)) : (e.config.NoRecordIP || (void 0 === window.MV.ip ? (0, a.
                            default)(e):
                        e.C.ip = window.MV.ip), t = [], window.md5 || t.push("npm/blueimp-md5@2.18.0/js/md5.min.js"), window.AV || t.push("npm/leancloud-storage@4/dist/av-min.js"), (0, i.
                        default)("https://cdn.jsdelivr.net/combine/" + t.join(","), (function() {
                        e.initCheck(),
            ...
            function(e, t, n) {
                ...
                e.exports = function(e) {
                    ...
                    i.
                    default.on("keydown", document, (function(n) {
                        var i = (n = event || n).keyCode || n.which || n.charCode; (n.ctrlKey || n.metaKey) && 13 === i && e.submitEvt(),
                        9 === i && "veditor" == (document.activeElement.className || "") && (n.preventDefault(), (0, a.
                            default)(t, "    "))
                    }));
                    var n = function(n) {
                        if (n.length) for (var i = function() {
                                var i = n[o],
                                    s = "![Uploading ".concat(i.name, "]()"); (0, a.
                                    default)(t, s),
                                    r(i, (function(n, a) { ! n && a && (t.value = t.value.replace(s, "\r\n![".concat(i.name, "](").concat(a.data.url, ")")), e.C.comment = t.value)
                                    }))
                            },
                                               o = 0; o < n.length; o++) i()
                    };
                    i.
                    default.on("paste", document, (function(e) {
                    ...
                    e.alert = {
                        show: function(n) {
                            ...
                            var i = t.querySelector(".btns"),
                                ...
                                o = n.type ? '<button class="sure button">'.concat(n.otxt || e.i18n.
                                    continue, "</button>") : "";
                            i.innerHTML = "".concat(r).concat(o),
                                ...
                                t.setAttribute("style", "display:block;"),
                            n.type && (o = t.querySelector(".sure"), a.
                            default.on("click", o, (function(t) {
                                e.alert.hide(),
                                n.cb && n.cb()
                            })))
                        },
            ...
            function(e, t, n) {
                ...
                e.exports = function(e) {
                    ...
                    i.
                    default.on("click", t, (function(t) {
                        var n = e.el.querySelector(".veditor");
                        void 0 !== (t = t.target.src) && (t = "!(:".concat(decodeURI(t).replace(/^.*\/(.*)$/, "$1"), ":)"), (0, a.
                            default)(n, t), e.C.comment = n.value, (n = e.el.querySelector(".vsubmit")).getAttribute("disabled") && n.removeAttribute("disabled"))
                    }))
                }
            },
            function(e, t, n) {
                ...
                e.exports = function(e) {
                    ...
                    e.reset = function() {
                        ...
                        e.C.rid = "",
                            e.C.nick = "",
                            e.C.at = "",
                            (e.el.querySelector(".form textarea").placeholder = "", a.
                                default)(e),
                            e.previewEvt(e),
            ...
            function(e, t, n) {
                ...
                e.exports = function(e) {
                    a.
                    default.on("click", e.el.querySelector(".cancel-reply"), (function(t) {
                        e.reset()
                    }))
                }
            },
                ...
                e.exports = function(e) {
                    ...
                    default.on("click", t, (function(e) {
                        i.getAttribute("triggered") && (i.setAttribute("style", "display:none;"), i.removeAttribute("triggered"), n.classList.remove("actived")),
                            r.getAttribute("triggered") ? (r.setAttribute("style", "display:none;"), r.removeAttribute("triggered"), t.classList.remove("actived")) : (r.removeAttribute("style"), r.setAttribute("triggered", 1), t.classList.add("actived"))
                    }))
                }
            },
            function(e, t, n) {
                ...
                e.exports = function(e) {
                    ...
                    a.
                    default.on("click", t, (function(a) {
                        if (r.getAttribute("triggered") && (r.setAttribute("style", "display:none;"), r.removeAttribute("triggered"), n.classList.remove("actived")), i.getAttribute("triggered")) i.setAttribute("style", "display:none;"),
            ...
            function(e, t, n) {
                ...
                e.exports = function(e) {
                    for (var t in e.inputs = {},
                        ...
                        e.mapping) e.mapping.hasOwnProperty(t) &&
                    function() {
                        var n = e.mapping[t],
                            i = e.el.querySelector(".".concat(t));
                        e.inputs[n] = i,
                            a.
                            default.on("input", i, (function(t) {
                                e.C[n] = i.value,
                                    e.previewEvt(e)
                            }))
                    } ()
                ...
                e.exports = function(e) {
                    ...
                    e.submitEvt = function(i) {
                        ...
                        t.getAttribute("disabled") ? e.alert.show({
                            ...
                            e.C.comment = e.TEXT,
                            "" !== e.C.at && (i = '<a class="at" href=\'#'.concat(e.C.pid, "'>").concat(e.C.at, "</a>"), new RegExp("^<p>").test(e.C.comment) ? e.C.comment = e.TEXT.replace("<p>", "<p>".concat(i, " , ")) : e.C.comment = i + " , " + e.C.comment);
                            var t = r.
                                default.mail(e.C.mail),
                                i = r.
                                default.link(e.C.link);
                            e.C.mail = t.k ? t.v: "",
                                e.C.link = i.k ? i.v: "",
                            ...
                            (0, a.
                                default)(e, e, o)) : e.inputs.nick.focus() : e.inputs.comment.focus()
                    };
                    var n = function() {
                    ...
                    i.
                    default.on("click", t, e.submitEvt)
                }
            },
            function(e, t, n) {
                "use strict";
                var i, a = (i = n(3)) && i.__esModule ? i: {
                    ...
                    r = n(40);
                e.exports = function(e, t, n) { ! e.md && void 0 !== e.config.md || (t.TEXT = (0, r.markdown)(t.TEXT)),
                    (0, a.
                        default)(t, n)
                }
            },
            ...
            function(e, t) {
                ...
                function p(e) {
                    ...
                    for (var i = arguments.length,
                             a = new Array(1 < i ? i - 1 : 0), r = 1; r < i; r++) a[r - 1] = arguments[r];
                ...
                var v = Object.freeze({
                        ...
                        mergeStreams: function(e, t, n) {
                            ...
                            for (; e.length || t.length;) {
                                ...
                                if (a += g(n.substring(i, u[0].offset)), i = u[0].offset, u === e) {
                                    ...
                                    r.reverse().forEach(s)
                                } else "start" === u[0].event ? r.push(u[0].node) : r.pop(),
                                    l(u.splice(0, 1)[0])
                            }
                    ...
                    w = function() { !
                        ...
                        var e = function(e) {
                            ...
                            return function() {
                                var n, i = s(e);
                                return n = t ? (n = s(this).constructor, Reflect.construct(i, arguments, n)) : i.apply(this, arguments),
                                    i = this,
                        ...
                        return u(t, [{
                            ...
                            {
                                key: "addSublanguage",
                                value: function(e, t) { (e = e.root).kind = t,
                                    e.sublanguage = !0,
                                    this.add(e)
                                }
                            },
...
function K(e) {
                            ...
                            for (var n = 1 < arguments.length && void 0 !== t ? t: "|", i = /\[(?:[^\\\]]|\\.)*\]|\(\??|\\([1-9][0-9]*)|\\./, a = 0, r = "", o = 0; o < e.length; o++) {
                                ...
                                for (0 < o && (r += n), r += "("; 0 < c.length;) {
                                    ...
                                    r += c.substring(0, l.index),
                                        ...
                                        "\\" === l[0][0] && l[1] ? r += "\\" + String(Number(l[1]) + s) : (r += l[0], "(" === l[0] && a++)
                                }
                                r += ")"
                            }
                            return r
            ...
            return u(e, [{
                ...
                },
                {
                    ...
                    value: function(e) {
                        ...
                        (e = t.exec(e)) && (this.regexIndex += e.position + 1, this.regexIndex === this.count && (this.regexIndex = 0)),
                            e
                    }
                }]),
                e
    ...
    return function i(a, s) {
        ...
        s && (a.beginKeywords && (a.begin = "\\b(" + a.beginKeywords.split(" ").join("|") + ")(?=\\b|\\s)", a.__beforeBegin = o), a.begin || (a.begin = /\B|\b/), c.beginRe = t(a.begin), a.endSameAsBegin && (a.end = a.begin), a.end || a.endsWithParent || (a.end = /\B|\b/), a.end && (c.endRe = t(a.end)), c.terminator_end = _(a.end) || "", a.endsWithParent && s.terminator_end && (c.terminator_end += (a.end ? "|": "") + s.terminator_end)),
        ...
        a.starts && i(a.starts, s),
            c.matcher = (s = c, l = new r, s.contains.forEach((function(e) {
...
var $ = {
    ...
    X = g, Q = p, J = v.nodeStream, Z = v.mergeStreams, W = Symbol("nomatch"); v = function(e) {
    var t = [],
    ...
    function m(e, t, a, r) {
        ...
        function l() {
            if (w.keywords) {
                ...
                for (var t = w.keywordPatternRe.exec(x), n = ""; t;) {
                    ...
                    r ? (r = (a = i(r, 2))[0], a = a[1], M.addText(n), n = "", S += a, M.addKeyword(t[0], r)) : n += t[0],
        ...
        function h(t, n) {
            ...
            if ("begin" === (p = n).type) return function(e) {
                for (var t = e[0], n = e.rule, i = new f(n), a = 0, r = [n.__beforeBegin, n["on:begin"]]; a < r.length; a++) {
                    var o = r[a];
                    if (o && (o(e, i), i.ignore)) return o = t,
                        0 === w.matcher.regexIndex ? (x += o[0], 1) : (A = !0, 0)
                }
            ...
            if ("end" === n.type && (r = function(e) {
                ...
                return i.starts && (i.endSameAsBegin && (i.starts.endRe = i.endRe), g(i.starts)),
        ...
        var b = E(e);
        if (!b) throw console.error(c.replace("{}", e)),
        ...
        try {
            for (w.matcher.considerAll();;) {
                N++,
                    A ? A = !1 : (w.matcher.lastIndex = C, w.matcher.considerAll());
    ...
    function b(e) {
        var t, n, i, r = null,
            o = function(e) {
                ...
                if (n) {
                    var i = E(n[1]);
                    return i || (console.warn(c.replace("{}", n[1])), console.warn("Falling back to no-highlight mode for this block.", e)),
                        i ? n[1] : "no-highlight"
                }
        ...
        g(o) || (S("before:highlightBlock", {
            block: e,
            language: o
        }), u.useBR ? (r = document.createElement("div")).innerHTML = e.innerHTML.replace(/\n/g, "").replace(/<br[ /] * >/g,"\n"):r=e,i=r.textContent,t=o?p(o,i,!0):v(i),(r=J(r)).length&&((n=document.createElement("div")).innerHTML=t.value,t.value=Z(r,J(n),i)),t.value=h(t.value),S("after:highlightBlock",{block:e,result:t}),e.innerHTML=t.value,e.className=(n=e.className,i=o,o=t.language,i=i?a[i]:o,o=[n.trim()],n.match(/\bhljs\b / ) || o.push("hljs"),
        n.includes(i) || o.push(i),
            o.join(" ").trim()), e.result = {
            language: t.language,
            re: t.relevance,
    ...
    for (y in Object.assign(e, {
        ...
        e.versionString = "10.2.0", H)"object" === d(H[y]) &&
    function e(t) {
        Object.freeze(t);
        var n = "function" == typeof t;
        return Object.getOwnPropertyNames(t).forEach((function(i) { ! Object.hasOwnProperty.call(t, i) || null === t[i] || "object" !== d(t[i]) && "function" != typeof t[i] || n && ("caller" === i || "callee" === i || "arguments" === i) || Object.isFrozen(t[i]) || e(t[i])
        })),
            t
    } (H[y]);
    ...
    e.exports = {
        ...
        link: function(e) {
            return 0 < e.length && (e = /^(http|https)/.test(e) ? e: "http://".concat(e)),
                {
                    k: !(0 < e.length) || /(http|https):\/\/[\w\-_]+(\.[\w\-_]+)+([\w\-\.,@?^=%&amp;:/~\ + #] * [\w\ - \@ ? ^=%&amp;
                    /~\+#])?/.test(e), v: e
                }
        }
    }
...
function(e, t, n) {
    ...
    t.MathJaxSupport = function(e) {
        "undefined" != typeof MathJax || !e.math && void 0 !== e.config.math || 1 != e.math && null != e.math || (0, a.
            default)(),
...
function(e, t, n) {
    "use strict";
    e.exports = function(e) {
        void 0 !== e.visitor && !e.visitor || n.e(1).then(n.t.bind(null, 63, 7)).then((function(t) { (0, t.MCo)(e.config)
        }))
    }
},
function(e, t, n) {
    ...
    e.exports = function(e) { !
        function(e) {
            ...
            t && !t.classList.contains("loaded") && AV.Query.doCloudQuery("select nick, mail, comment, url from Comment where (rid='' or rid is not exists) order by -createdAt limit 0,10").then((function(n) {
                ...
                if (i) {
                    for (var r = "",
                             o = 0; o < i; o++) r += '<li class="item"><a href="/' + n[o].get("url") + "#" + n[o].id + '"><span class="breadcrumb">' + n[o].get("nick") + " @ " + (0, a.
                        default)(n[o].get("createdAt"), e.i18n) + "</span><span>" + n[o].get("comment").replace(/<[^>]+>/gi, "").substr(0, 100) + "</span></a></li>";
                    t.innerHTML = r,
